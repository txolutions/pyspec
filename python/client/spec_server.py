...
class SpecHandler(asyncore.dispatcher):
    ...
    def handle_read(self):
        try:
            ...
            log.log(2, "oooh. something arrived")
            ...
            while offset < len(sbuffer):
                ...
                if self.message.isComplete():
                    ...
                    if self.message.cmd == SpecMessage.HELLO:
                        log.log(2, "hello message received")
    ...
    def send_hello_reply(self, reply_id, serverName):
        log.log(2, "sending reply with server name=%s" % serverName)
...
class SpecServer(asyncore.dispatcher):
    ...
    def run(self):
        ...
        log.log(2, " - starting server loop..")
        self.updater.start() 
        log.log(2, " - started..")
...
if __name__ == "__main__":
    ...
    log.start()
    name  = sys.argv[1]
    server = SpecServer(host='localhost', name=name)
